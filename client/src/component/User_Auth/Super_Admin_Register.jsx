    ...
    <>
      <div className="signup_container">
        ...
        <div className="close_register">
          <Link to='/super_admin'>
          <i
            className="bx bx-message-square-x bx-flashing"
            onClick={() => setAddUser(false)}
          ></i>
          </Link>
        
          <i className="bx bxs-chevrons-up bx-fade-up"></i>
        </div>
        ...
        <div className="Admin_box_container">
...
export default Super_Admin_Register;
