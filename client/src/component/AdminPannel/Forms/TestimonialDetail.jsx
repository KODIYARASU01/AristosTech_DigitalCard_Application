...
const TestimonialDetail = () => {
  ...
  useEffect(() => {
    let fetchTestimonial = async () => {
      setLoader4(true)
      await axios
        .get(`https://aristostech-digitalcard-application.onrender.comigitalcard-application.onrender.com/testimonialDetail/specific/${id}`, {
          headers: {
  ...
  async function handleTestimonialFormSubmit(e) {
    ...
    try {
      ...
      await axios
        .post(`https://aristostech-digitalcard-application.onrender.comigitalcard-application.onrender.com/testimonialDetail`, SocialMediadata, {
          headers: {
  ...
  async function handleTestimonialUpdate(e) {
    ...
    try {
      ...
      await axios
        .put(
          `https://aristostech-digitalcard-application.onrender.comigitalcard-application.onrender.com/testimonialDetail/update/${TestimonialID}`,
          data,
          {
            headers: {
              Authorization: `Bearer ${id.token}`,
  ...
  async function handleTestimonialEdit(e) {
    ...
    let id = JSON.parse(localStorage.getItem("datas"));
    await axios
      .get(`https://aristostech-digitalcard-application.onrender.comigitalcard-application.onrender.com/testimonialDetail/specificId/${e.target.id}`, {
        headers: {
          Authorization: `Bearer ${id.token}`,
        },
      })
  ...
  async function handleTestimonialDelete(e) {
    ...
    let id = JSON.parse(localStorage.getItem("datas"));
    await axios
      .delete(`https://aristostech-digitalcard-application.onrender.comigitalcard-application.onrender.com/testimonialDetail/delete/${e.target.id}`, {
        headers: {
          Authorization: `Bearer ${id.token}`,
        },
      })
