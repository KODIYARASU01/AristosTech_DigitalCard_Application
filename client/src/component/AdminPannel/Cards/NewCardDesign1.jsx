                ...
                <div className="box-3">
                  <div className="contact_details">
                    ...
                    <div className="box">
                      ...
                      <div className="data">
                        <p> {AllData.ContactDetails[0].DOB || "22/01/2021"}</p>
                    ...
                    <div className="box">
                      ...
                      <div className="data">
                        <p>
                          {" "}
                          {stripHtmlTags1(AllData.ContactDetails[0].Address) ||
                ...
                <div className="box-8">
                  ...
                  <div className="qrcode">
                    <div className="qrcode_images">
                      <img src={AllData.BasicDetail[0].logo||avatar} alt="logo" />
