                ...
                <Carousel autoPlay='true' >
                  <div className="content">
                    <div className="user_Detail">
                      ...
                      <div className="name">
                        <p>
                          Kodiyarasu <i className="bx bxs-heart"></i>
                        </p>
                    ...
                    <div className="feedbacks">
                      <p>
                        <i className="uil uil-comment-alt-heart"></i>Lorem ipsum
                        dolor sit amet, consectetur adipisicing elit. Maiores ut
                        harum quo id ab sequi similique odio quisquam voluptates
                        ex.
                      </p>
                    </div>
                  ...
                  <div className="content">
                    <div className="user_Detail">
                      ...
                      <div className="name">
                        <p>
                          VijayKumar <i className="bx bxs-heart"></i>
                        </p>
              ...
              <form action="" ref={form} onSubmit={formik.handleSubmit}>
                ...
                <div className="form_group">
                  <label
                    ...
                    className={`${formik.errors.clientEmail1 ? "error" : ""} `}
                  >
